<#-----------------------------------------------------------------------------
  ...
  Extras - Installing Docker and SQL Server
...
# Linux
Set-Location '/home/arcanecode/code/PSCore-for-SQLServer'

# macOS
Set-Location '/Users/arcanecode/OneDrive/APress/Code/PSCore-for-SQLServer' 
